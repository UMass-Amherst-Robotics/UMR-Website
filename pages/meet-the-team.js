...
export default function Team() {
  ...
  let execs = [
    {name: "Sam Dubois", image: "/Profiles/SamPicture.png", execRole: "President", major: "C.S. and Computer Engineering", work: "Electronics, programming", hobbies: "Rock climbing, machining", diningHall: "Berk", linkedInIcon: icon("https://www.linkedin.com/in/samuel-dubois/", linkedInIcon), gitHubIcon: icon('https://github.com/sdubois18', gitHubIcon)},
    {name: "Sean Flanagan", image: "/Profiles/SeanFlanPicture.png", execRole: "Vice-President", major: "Mechanical Engineering", work: "Mechanical design, analysis", hobbies: "Spikeball, volleyball, table tennis", diningHall: "Hamp", linkedInIcon: icon("https://www.linkedin.com/in/sean-flanagan-997480157/", linkedInIcon), gitHubIcon: icon("https://github.com/smflanagan", gitHubIcon)},
    {name: "Dom Locurto", image: "/Profiles/DomPicture.png", execRole: "Treasurer", major: "Mechanical Engineering", work: "Mechanical design, analysis", hobbies: "Ultimate frisbee, cooking, gaming", diningHall: "Hamp", linkedInIcon: icon("http://linkedin.com/in/dominic-locurto-888103194", linkedInIcon), gitHubIcon: icon("https://github.com/DomLocurto", gitHubIcon)},
    {name: "Alex Klinkhamer", image: "/Profiles/AlexPicture.png", execRole: "Secretary", major: "Mechanical Engineering", work: "Mechanical design, analysis", hobbies: "3D printing, designing, CAD, running", diningHall: "Worcester", gitHubIcon: icon("https://github.com/Aklinkhamer", gitHubIcon)},
    {name: "Jagath Jai Kumar", image: "/Profiles/JagathPicture.png", execRole: "Cyber Forensics Research Fellow", major: "C.S. Graduate", work: "General advising and mentorship", hobbies: "Rock climbing, 3D printing", diningHall: "Berk", linkedInIcon: icon("https://www.linkedin.com/in/jagath-jai-kumar/", linkedInIcon), gitHubIcon: icon("https://github.com/jagath-jaikumar", gitHubIcon)},
    {name: "Adam Rivelli", image: "/Profiles/AdamPicture.png", execRole: "C.S. Master's Student", major: "C.S. and Mechanical Engineering Graduate", work: "Mechanical engineering mentorship", hobbies: "Rock climbing, running, hiking", diningHall: "Worcester", linkedInIcon: icon("https://www.linkedin.com/in/adam-rivelli", linkedInIcon), gitHubIcon: icon("https://github.com/AdamRivelli", gitHubIcon)}
  ]

  let members = [
    {name: "Mike Brauninger", image: "/Profiles/MikePic.png", major: "Computer Engineering", work: "Electronics, programming, website design", hobbies: "Frisbee, guitar, fishing", diningHall: "Berk", linkedInIcon: icon("https://www.linkedin.com/in/mbrauninger/", linkedInIcon), gitHubIcon: icon("https://github.com/mbrauninger", gitHubIcon)},
    {name: "Andrew Tran", image: "/Profiles/AndrewPicture.png", major: "Computer Engineering", work: "Electronics, programming, website design", hobbies: "Cooking, personal coding projects", diningHall: "Worcester", linkedInIcon: icon("https://www.linkedin.com/in/umass-andrew-tran/", linkedInIcon), gitHubIcon: icon("https://github.com/andrewtran10", gitHubIcon)},
    {name: "Aidan Downey", image: "/Profiles/AidanPicture.png", major: "Mechanical Engineering", work: "Mechanical design, analysis", hobbies: "Sailing, guitar, gain time", diningHall: "Berk", gitHubIcon: icon("https://github.com/apdowney", gitHubIcon)},
